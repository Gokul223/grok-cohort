            ...
            case CHROME:
                ...
                if (useRemote) {
                    try {
                        ...
                        return new RemoteWebDriver(new URL("http://57.159.26.76:32000/wd/hub"), chromeOptions);
            ...
            case FIREFOX:
                ...
                if (useRemote) {
                    try {
                        ...
                        return new RemoteWebDriver(new URL("http://57.159.26.76:32000/wd/hub"), firefoxOptions);
                    } catch (MalformedURLException e) {
                        throw new RuntimeException("Invalid Selenium Grid URL", e);
                    }
                } else {
